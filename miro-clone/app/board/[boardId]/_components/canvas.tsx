...
import { Camera, CanvasMode, CanvasState, Color, LayerType, Point, Layer, Side, XYWH} from "@/types/canvas";
...
import { connectionIdToColor, findIntersectingLayersWithRectangle, pointerEventToCanvasPoint, resizeBounds, penPointToPathLayer, colorToCss } from "@/lib/utils";
...
export const Canvas = ({ boardId }: CanvasProps) => {   
    ...
    const insertLayer = useMutation((
        ...
        const layer: LiveObject<Layer> = new LiveObject({ 
            type: layerType, 
            x: position.x,  
            y: position.y,  
            height: 100, 
    ...
    const startMultiSelection = useCallback((
        ...
        if(
            ...
            console.log("ATTEMPRING TO SELECTION NET"); 
            setCanvasState({ 
                mode: CanvasMode.SelectionNet, 
                origin, 
                current
    ...
    }, [ lastUsedColor, canvasState, setCanvasState ]); 
    ...
    }, [ canvasState, translateSelectedLayers, continueDrawing, startMultiSelection, updateSelectionNet, resizeSelectedLayer]); 
            ...
            <svg 
                ...
                >
                    ...
                    { canvasState.mode === CanvasMode.SelectionNet && canvasState.current != null && 
                        ( 
                            <rect
                                className = "fill-blue-500/5 stoke-blue-500 stroke-1"
