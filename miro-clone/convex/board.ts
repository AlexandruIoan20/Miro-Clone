...
export const remove = mutation({ 
    ...
    handler: async (context, args) => { 
        ...
        const existingFavourite = await context.db
            ...
            if(existingFavourite) await context.db.delete(existingFavourite._id); 
...
export const update = mutation({ 
    ...
    handler: async (context, args) => { 
        ...
        if(title.length > 60) throw new Error("Title cannot be longer than 60 caracters."); 
...
export const unfavourite = mutation({ 
    ...
    handler: async(context, args) => { 
        ...
        if(!existingFavourite) throw new Error("Favourite board not found"); 
